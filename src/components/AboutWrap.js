...
const textTwo =
  'Studia które skończyłem to Zarządzanie i Inżynieria produkcji oraz Towaroznawstwo na Uniwersytecie Ekonomicznym w Krakowie, w między czasie pracowałem w gastronomii jako barman, co nauczyło mnie pracy zespołowej i "niesamowitej" cierpliwości w kontaktach z klientami.';
